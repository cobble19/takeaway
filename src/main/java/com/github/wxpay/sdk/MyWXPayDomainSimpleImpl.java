 ...
 */
public class MyWXPayDomainSimpleImpl implements IWXPayDomain {
    private MyWXPayDomainSimpleImpl(){}
    private static class WxpayDomainHolder{
        private static IWXPayDomain holder = new MyWXPayDomainSimpleImpl();
    }
