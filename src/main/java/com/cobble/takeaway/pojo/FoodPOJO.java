...
public class FoodPOJO extends BasePOJO {
    ...
    private FoodTypePOJO foodTypePOJO;
	...
	public FoodTypePOJO getFoodTypePOJO() {
		return foodTypePOJO;
	}
	public void setFoodTypePOJO(FoodTypePOJO foodTypePOJO) {
		this.foodTypePOJO = foodTypePOJO;
	}
}