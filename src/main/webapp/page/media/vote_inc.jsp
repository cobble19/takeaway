    ...
    pageEncoding="UTF-8"%>
	     			...
	     			<div id="create_vote">
	     				...
	     				<div style=" height:50px; line-height:50px;">
	     					<a class="btn btn-primary btn-xs" target="_blank" href='<cmn:base/>/page/media/vote_add.jsp'>添加</a>
	     			...
	     			<script type="text/javascript" charset="utf-8" src="<cmn:base/>/js/media/vote_inc.js"></script>
