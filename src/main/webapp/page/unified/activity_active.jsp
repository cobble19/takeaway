...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" charset="utf-8" src="<cmn:base/>/js/unified/activity_active.js"></script>
  </head>
  <body>
               ...
               <div class="col-xs-12 col-md-4">
                 <div class="thumbnail">
                    ...
                    <div class="caption">
                       ...
                       <p><a style="color:#FFF;" href='<cmn:base/>/page/unified/activity_detail.jsp?activityId=${activityPOJO.activityId}' class="btn btn-primary" role="button">点击参与活动</a></p>
                    </div>
                 </div>
               </div>
            </div>    
