  ...
  <body>
  	<div class="container">
  		...
  		<form id="awardForm" class="form-horizontal" role="form" action='<cmn:base/>/web/unified/award/add' method="post">
	  		<input type="hidden" id="awardId" name="awardId" value="${awardPOJO.awardId}"/>
 			...
 			<div class="form-group">
 				...
 				<div class="">
 					<input class="form-control" id="orderNo" name="orderNo" value="${awardPOJO.orderNo}" placeholder="请输入序号">
 				</div>
 			</div>
 			<div class="form-group">
	 			<div class="">
