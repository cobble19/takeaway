  	...
  	<div class="container">
  		...
  		<form id="voteForm" class="form-horizontal" role="form" action='<cmn:base/>/web/unified/vote/add' method="post">
 			...
 			<div class="form-group">
 				...
 				<div class="">
 					<input class="form-control" id="period" name="period" required="required" placeholder="请输入投票周期(7-7天投一次票), 例如 1, 7">
 				</div>
 			</div><div class="form-group">
 				<label class="control-label" for="numOfPeriod">每次可投票个数:</label>
 				<div class="">
 					<input class="form-control" id="numOfPeriod" name="numOfPeriod" required="required" placeholder="请输入每周期投票个数(可给几个人投票), 例如1, 3名">
 				</div>
 			</div>
 			<!-- <div class="form-group">
