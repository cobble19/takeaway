...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" charset="utf-8" src="<cmn:base/>/js/unified/award_record_add.js"></script>
  	...
  	<div class="container">
  		...
  		<form id="awardRecordForm" class="form-horizontal" role="form" action='<cmn:base/>/web/unified/awardRecord/add' method="post">
 			...
 			<div class="form-group">
 				...
 				<div class="">
 					<input class="form-control" id="awardId" name="awardId" placeholder="请输入奖品ID">
 				</div>
 			</div>
 			<div class="form-group">
 			...
 			<div class="form-group">
 				...
 				<div class="">
 					<input class="form-control" id="hitDateTime" name="hitDateTime" placeholder="请输入获奖日期">
 				</div>
 			</div>
 			<div class="form-group">
	 			<div class="">
