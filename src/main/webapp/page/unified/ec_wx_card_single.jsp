...
<html lang="en">
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="<cmn:base/>/js/unified/ec_wx_card_single.js"></script>
	</head>
	     		...
	     		<div id="uc_content" style="padding-top:40px;">
	     			...
	     			<div id="ecWxCard">
	     				...
	     				<div style=" height:50px; line-height:50px;">
	     					<a class="btn btn-primary btn-xs" target="_blank" href='<cmn:base/>/page/unified/ec_wx_card_add.jsp'>添加</a>
	     					
	     					<input id="searchBtn4EcWxCard" type="button" class="btn btn-default btn-xs" value="查询">
	     					<input id="deleteBtn4EcWxCard" type="button" class="btn btn-default btn-xs" value="删除">
	     					
	     				</div>
				  		<table id="dbTable4EcWxCard" class="display table table-striped table-bordered" cellspacing="0" width="100%">
				  				<thead>
				  					<tr>
				  						<th><input type="checkbox" name="chkBoxAll4EcWxCard" id="chkBoxAll4EcWxCard">全选</th>
				  						<th>序号</th>
				  						<th>标识ID</th>
				  						<th>用户ID</th>
										<th>公众号appID</th>
