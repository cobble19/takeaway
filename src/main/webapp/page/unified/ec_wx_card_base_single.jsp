...
<html lang="en">
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="<cmn:base/>/js/unified/ec_wx_card_base_single.js"></script>
	</head>
  		...
  		<div class="row" style="min-height:500px; border:1px solid #CCC;">
	     	...
	     	<div class="col-md-9 col-xs-8" style="min-height:500px;">
	     		<div id="uc_content" style="padding-top:40px;">
	     			...
	     			<div id="ecWxCardBase">
	     				<h3>用户已经拥有的卡券在jssdk获取卡券功能之前</h3>
	     				<div style=" height:50px; line-height:50px;">
	     					<a class="btn btn-primary btn-xs" target="_blank" href='<cmn:base/>/page/unified/ec_wx_card_base_add.jsp'>添加</a>
	     					
	     					<input id="searchBtn4EcWxCardBase" type="button" class="btn btn-default btn-xs" value="查询">
	     					<input id="deleteBtn4EcWxCardBase" type="button" class="btn btn-default btn-xs" value="删除">
	     					
	     				</div>
				  		<table id="dbTable4EcWxCardBase" class="display table table-striped table-bordered" cellspacing="0" width="100%">
				  				<thead>
				  					<tr>
				  						<th><input type="checkbox" name="chkBoxAll4EcWxCardBase" id="chkBoxAll4EcWxCardBase">全选</th>
				  						<th>序号</th>
				  						<th>标识ID</th>
				  						<th>用户ID</th>
										<th>公众号appID</th>
