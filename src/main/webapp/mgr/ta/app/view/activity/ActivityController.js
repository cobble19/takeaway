 ...
 */
Ext.define('TA.view.activity.ActivityController', {
    ...
    init: function() {
    	console.log('ActivityController init.');
    	this.activitylist = this.getView();
    	console.log('get view: ' + this.activitylist);
		
	},
	onAdd: function(button, e) {
		console.log('onAdd ' + button + " " + e);
		var window = Ext.widget('activityedit');
	...
	add: function(button, e) {
		...
		form.submit({
			...
			success: function(form, action) {
				...
				store.insert(0, new TA.model.Activity());
	...
	deleteRecord: function(records) {
        ...
        Ext.each(records, function(record, index) {
        	ids.push(record.get('activityId'));
        });
