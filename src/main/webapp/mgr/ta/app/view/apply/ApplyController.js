 ...
 */
Ext.define('TA.view.apply.ApplyController', {
    ...
    init: function() {
    	...
    	this.applylist = this.getView();
    	console.log('get view: ' + this.applylist);
		
	},
	onAdd: function(button, e) {
		console.log('onAdd ' + button + " " + e);
		var window = Ext.widget('applyedit');
	...
	add: function(button, e) {
		...
		form.submit({
			...
			success: function(form, action) {
				...
				store.insert(0, new TA.model.Apply());
	...
	deleteRecord: function(records) {
        ...
        Ext.each(records, function(record, index) {
        	ids.push(record.get('applyId'));
        });
        
        Ext.Ajax.request({
            url: '../../mgr/apply/delete',
            params: {ids:ids},
            method: 'POST',
