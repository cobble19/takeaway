 ...
 */
Ext.define('TA.view.locationbusiness.LocationBusinessController', {
    ...
    alias: 'controller.locationbusiness',
    stores: ['LocationBusiness'],
    views: ['locationbusiness.List'],
    init: function() {
    	console.log('LocationBusinessController init.');
	},
	onAdd: function(button, e) {
		console.log('onAdd ' + button + " " + e);
		var window = Ext.widget('locationbusinessedit');
	...
	add: function(button, e) {
		...
		var store = Ext.getStore('LocationBusiness');
		/*if (form.isValid()) {
		...
		form.submit({
			...
			success: function(form, action) {
				...
				store.insert(0, new TA.model.LocationBusiness());
	...
	deleteRecord: function(records) {
        ...
        Ext.each(records, function(record, index) {
        	ids.push(record.get('locationBusinessId'));
        });
