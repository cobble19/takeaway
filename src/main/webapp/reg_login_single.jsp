...
<body>
	...
	<div class="row">
        ...
        <div class="col-xs-5 col-xs-offset-1 visible-xs"></div>
        <div class="col-md-4 col-md-offset-7 col-xs-6">
			<c:if test="${(empty username) or (not empty username and username eq 'anonymousUser')}">
	        <button id="regBtnDefault" style="float:right;" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal">注册</button>
	        <button id="loginBtnDefault" style="float:right; margin-right:10px;" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#loginModal">登陆</button>
	        </c:if> 
	    	...
	    	<div class="modal-dialog">
	    		<div class="modal-content">
	    			...
	    			<div class="modal-footer">
	    				<a href="#" id="goLoginBtn">如有账号， 请点击登录</a>
	    ...
	    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    	<div class="modal-dialog">
	    		<div class="modal-content">
	    			...
	    			<div class="modal-footer">
	    				<a href="#" id="goRegBtn" >若无账号， 请点击注册</a>
	    				<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
