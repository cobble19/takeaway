...
//			alert('结束时间不能小于开始时间');
	...
	$('#wxMenuMgrMatchRuleForm').validate();

//	$('#wxMenuMgrMatchRuleForm').find('#uploadBtn').click(function(e) {
...
//	});	// upload pic to picture files
	...
	$('#addBtn').click(function(e) {
		...
		if ($('#wxMenuMgrMatchRuleForm').valid()) {
			$('#wxMenuMgrMatchRuleForm').submit();
		}
		return ;
	})
...
var showDetail = function() {
	var wxMenuMgrMatchRuleId = getParam('wxMenuMgrMatchRuleId');
	$.ajax({
		"url" : "../../api/unified/wxMenuMgrMatchRule/" + wxMenuMgrMatchRuleId,
		"type" : "GET",
		"headers" : {
