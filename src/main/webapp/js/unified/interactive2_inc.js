...
$(document).ready(function() {
    ...
    var table4Interactive2 = $('#dbTable4Interactive2').DataTable( {
    	"processing": true,
...
//				var startDateTime = new Date(full.startDateTime);
			...
			"render" : function(data, type, full, meta) {
				...
				content += '...>>';
				var link = '<a target="_blank" href="../../page/unified/interactive_detail.jsp?interactiveId=' + full.interactiveId + '">' +
						content + '</a>';
				return link;
			}
		}, {
    ...
    table4Interactive2.on( 'order.dt search.dt', function () {
    	table4Interactive2.column(1, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
            cell.innerHTML = i+1;
        } );
    } ).draw();

    interactiveSearch(table4Interactive2);
    $('#searchBtn4Interactive2').click(function() {
    ...
    $('#deleteBtn4Interactive2').click(function() {
    	var ids = [];
    	var chkBox = $('#dbTable4Interactive2').find('input[name=chkBox]');
