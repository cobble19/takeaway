...
//			alert('结束时间不能小于开始时间');
	...
	$('#wxPersonUserForm').validate();

//	$('#wxPersonUserForm').find('#uploadBtn').click(function(e) {
...
//	});	// upload pic to picture files
	...
	$('#addBtn').click(function(e) {
		...
		if ($('#wxPersonUserForm').valid()) {
			$('#wxPersonUserForm').submit();
		}
		return ;
	})
...
var showDetail = function() {
	var wxPersonUserId = getParam('wxPersonUserId');
	$.ajax({
		"url" : "../../api/unified/wxPersonUser/" + wxPersonUserId,
		"type" : "GET",
		"headers" : {
