...
//			alert('结束时间不能小于开始时间');
	...
	$('#pointEventForm').validate();

//	$('#pointEventForm').find('#uploadBtn').click(function(e) {
...
//	});	// upload pic to picture files
	...
	$('#addBtn').click(function(e) {
		...
		if ($('#pointEventForm').valid()) {
			$('#pointEventForm').submit();
		}
		return ;
	})
...
var showDetail = function() {
	var pointEventId = getParam('pointEventId');
	$.ajax({
		"url" : "../../api/unified/pointEvent/" + pointEventId,
		"type" : "GET",
		"headers" : {
