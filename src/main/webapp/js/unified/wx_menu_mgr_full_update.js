...
//			alert('结束时间不能小于开始时间');
	...
	$('#wxMenuMgrFullForm').validate();

//	$('#wxMenuMgrFullForm').find('#uploadBtn').click(function(e) {
...
var showDetail = function() {
	var wxMenuMgrFullId = getParam('wxMenuMgrFullId');
	$.ajax({
		"url" : "../../api/unified/wxMenuMgrFull/" + wxMenuMgrFullId,
		"type" : "GET",
		"headers" : {
