...
//			alert('结束时间不能小于开始时间');
	...
	$('#pointSummaryForm').validate();

//	$('#pointSummaryForm').find('#uploadBtn').click(function(e) {
...
//	});	// upload pic to picture files
	...
	$('#addBtn').click(function(e) {
		...
		if ($('#pointSummaryForm').valid()) {
			$('#pointSummaryForm').submit();
		}
		return ;
	})
...
var showDetail = function() {
	var pointSummaryId = getParam('pointSummaryId');
	$.ajax({
		"url" : "../../api/unified/pointSummary/" + pointSummaryId,
		"type" : "GET",
		"headers" : {
