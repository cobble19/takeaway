...
//			alert('结束时间不能小于开始时间');
	...
	$('#pointRecordForm').validate();

//	$('#pointRecordForm').find('#uploadBtn').click(function(e) {
...
//	});	// upload pic to picture files
	...
	$('#addBtn').click(function(e) {
		...
		if ($('#pointRecordForm').valid()) {
			$('#pointRecordForm').submit();
		}
		return ;
	})
...
var showDetail = function() {
	var pointRecordId = getParam('pointRecordId');
	$.ajax({
		"url" : "../../api/unified/pointRecord/" + pointRecordId,
		"type" : "GET",
		"headers" : {
