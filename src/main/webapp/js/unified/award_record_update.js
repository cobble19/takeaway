...
//			alert('结束时间不能小于开始时间');
	...
	/*showDetail();*/
	$('#hitDateTime').datetimepicker({
		lang:'ch',
		timepicker:true,
		/*format: 'Y-m-d H:i'*/
		value: '2015-02-20 20:20:20'
	});
	$('#awardRecordForm').validate();

//	$('#awardRecordForm').find('#uploadBtn').click(function(e) {
...
//	});	// upload pic to picture files
	...
	$('#addBtn').click(function(e) {
		...
		if ($('#awardRecordForm').valid()) {
			$('#awardRecordForm').submit();
		}
		return ;
	})
...
var showDetail = function() {
	var awardRecordId = getParam('awardRecordId');
	$.ajax({
		"url" : "../../api/unified/awardRecord/" + awardRecordId,
		"type" : "GET",
		"headers" : {
